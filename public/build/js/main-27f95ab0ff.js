...
},{"process/browser.js":3,"timers":1}],2:[function(require,module,exports){
(function (global){
/**
 * @license
...
},{"_process":3,"timers":1}],6:[function(require,module,exports){
...
exports.default = {
  ...
  methods: {
    setSearchTerm: _lodash2.default.debounce(function () {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-469417c0", module.exports)
  } else {
    hotAPI.update("_v-469417c0", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"lodash":2,"vue":5,"vue-hot-reload-api":4,"vueify/lib/insert-css":6}],8:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("/* line 3, stdin */\n.select-standard-wrapper label[_v-39f773af] {\n  display: inline-block; }\n\n/* line 7, stdin */\n.select-error[_v-39f773af] {\n  border: 1px solid tomato !important; }\n\n@media (max-width: 768px) {\n  /* line 12, stdin */\n  .cp-table-controls .limit-select select[_v-39f773af] {\n    min-width: 96px; } }\n")
'use strict';
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<span class=\"select-standard-wrapper\" _v-39f773af=\"\">\n  <label v-if=\"!hideLabel\" _v-39f773af=\"\">{{ label }}</label>\n    <div class=\"cp-select-standard\" _v-39f773af=\"\">\n      <select :class=\"{ 'select-error': error, 'error': error }\" ref=\"input\" v-model=\"value\" _v-39f773af=\"\">\n        <option v-for=\"option in options\" :value=\"option[keyValue['value']] || option\" _v-39f773af=\"\">{{ option[keyValue['name']] || option.name }}</option>\n      </select>\n    </div>\n    <span :class=\"{ 'cp-validation-errors': error }\" v-if=\"error\" _v-39f773af=\"\">{{ error[0] }}</span>\n</span>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-39f773af", module.exports)
  } else {
    hotAPI.update("_v-39f773af", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":5,"vue-hot-reload-api":4,"vueify/lib/insert-css":6}],9:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("/* line 2, stdin */\n.cp-table-controls {\n  display: -ms-flexbox;\n  display: flex; }\n  /* line 4, stdin */\n  .cp-table-controls .col {\n    -ms-flex: 1;\n        flex: 1; }\n  /* line 7, stdin */\n  .cp-table-controls .right {\n    float: right; }\n  /* line 11, stdin */\n  .cp-table-controls .total-records label {\n    padding-top: 5px; }\n  /* line 15, stdin */\n  .cp-table-controls .limit-select {\n    margin-right: 5px; }\n    /* line 17, stdin */\n    .cp-table-controls .limit-select select {\n      width: 60px;\n      min-width: 60px; }\n\n@media (max-width: 476px) {\n  /* line 25, stdin */\n  .cp-table-controls {\n    display: block;\n    margin-bottom: 80px; } }\n\n@media (max-width: 768px) {\n  /* line 31, stdin */\n  .cp-table-controls {\n    display: block; }\n    /* line 33, stdin */\n    .cp-table-controls .right {\n      float: none; }\n    /* line 36, stdin */\n    .cp-table-controls .cp-search-box {\n      padding: 0px 10px; }\n      /* line 38, stdin */\n      .cp-table-controls .cp-search-box > input {\n        width: 90% !important; } }\n")
'use strict';
...
exports.default = {
  ...
  methods: {
    setDefaultPerPage: function setDefaultPerPage() {
      this.perPageDefaultSet = true;
      this.getRecords();
    },

    getRecordsWithDelay: _lodash2.default.debounce(function () {
  ...
  watch: {
    'indexRequest.search_term': _lodash2.default.debounce(function () {
      this.indexRequest.current_page = 1;
      this.resourceInfo.current_page = 1;
      this.getRecords();
    }, 400),
    'indexRequest.per_page': function indexRequestPer_page() {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-3200003d", module.exports)
  } else {
    hotAPI.update("_v-3200003d", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../inputs/SearchBox.vue":7,"../inputs/Select.vue":8,"lodash":2,"vue":5,"vue-hot-reload-api":4,"vueify/lib/insert-css":6}],10:[function(require,module,exports){
'use strict';

var VueBootstrapPagination$1 = { render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('nav', [_vm.pagination.last_page > 0 ? _c('ul', { staticClass: "pagination", class: _vm.sizeClass }, [_vm.showPrevious() ? _c('li', { class: { 'disabled': _vm.pagination.current_page <= 1 } }, [_vm.pagination.current_page <= 1 ? _c('span', [_c('span', { attrs: { "aria-hidden": "true" } }, [_vm._v(_vm._s(_vm.config.previousText))])]) : _vm._e(), _vm.pagination.current_page > 1 ? _c('a', { attrs: { "href": "#", "aria-label": _vm.config.ariaPrevioius }, on: { "click": function click($event) {
          $event.preventDefault();_vm.changePage(_vm.pagination.current_page - 1);
        } } }, [_c('span', { attrs: { "aria-hidden": "true" } }, [_vm._v(_vm._s(_vm.config.previousText))])]) : _vm._e()]) : _vm._e(), _vm._l(_vm.array, function (num) {
      return _c('li', { class: { 'active': num === _vm.pagination.current_page } }, [_c('a', { attrs: { "href": "#" }, on: { "click": function click($event) {
            $event.preventDefault();_vm.changePage(num);
          } } }, [_vm._v(_vm._s(num))])]);
    }), _vm.showNext() ? _c('li', { class: { 'disabled': _vm.pagination.current_page === _vm.pagination.last_page || _vm.pagination.last_page === 0 } }, [_vm.pagination.current_page === _vm.pagination.last_page || _vm.pagination.last_page === 0 ? _c('span', [_c('span', { attrs: { "aria-hidden": "true" } }, [_vm._v(_vm._s(_vm.config.nextText))])]) : _vm._e(), _vm.pagination.current_page < _vm.pagination.last_page ? _c('a', { attrs: { "href": "#", "aria-label": _vm.config.ariaNext }, on: { "click": function click($event) {
          $event.preventDefault();_vm.changePage(_vm.pagination.current_page + 1);
        } } }, [_c('span', { attrs: { "aria-hidden": "true" } }, [_vm._v(_vm._s(_vm.config.nextText))])]) : _vm._e()]) : _vm._e()], 2) : _vm._e()]);
  }, staticRenderFns: [],
  name: 'pagination',
  props: {
    pagination: {
  ...
  watch: {
    'pagination.per_page': function pagination_per_page(newVal, oldVal) {
      // eslint-disable-line
      if (+newVal !== +oldVal) {
        // this.callback()
      }
...
},{"./components/tournaments/index.vue":11,"vue":5}]},{},[12]);
